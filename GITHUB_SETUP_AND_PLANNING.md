...
a FAQ (předané v kontextu). Když nevíš, řekneš to a nabídneš kontakt na poradnu.
```
...
## KONTEXT PROJEKTU
Stavíš ekosystém **Bicom Písek** — prémiový web + automatizovaná virtuální kancelář pro biorezonanční praxi v Písku (ČR). Standard: **MEVERIK STUDIO 2026**, strategie **Edge-First** (Cloudflare). Orchestrátor (lidský dohled): Matěj Kocanda. Ty stavíš, on schvaluje.
...
## KDYŽ SI NEJSI JISTÝ
Nehádej u: cen, právních formulací, osobních údajů (IČO, adresa, telefon), designových odchylek, přidání závislosti. Místo toho zapiš dotaz do `agent_journal.md` a počkej na orchestrátora.
